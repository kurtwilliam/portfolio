...
class GameOfLifeHelp extends Component {
  ...
  render() {
    ...
    const { hideDevNotes, currentPage } = this.state;
    return (
        ...
        {hideDevNotes ? (
          ...
          <>
            ...
            <p>
              ...
              is a cellular automaton that takes place 2D grid, where each cell
              is either Alive or Dead. After each generation, each square counts
              how many Alive neighbours it has, and if:
            </p>
            <span className="gol__help--big-rule">
              The current Cell is Alive
            </span>
            <div className="gol__help--rule">
              <span className="gol__help--rule">
            ...
            <div className="gol__help--hidden-rule">
            ...
            <p>
              ...
              grid but it was not performant at all. I researched, and decided a
